...
import ListItem from './components/home'
import './App.css'
...
class App extends Component {
  ...
  render() {
    const {activeTabId, time} = this.state
    ...
    return (
      <>
          ...
          <div className="score-container">
            <div>
              <p className="header-paragraph">
                Score: <span className="spam-paragraph">0</span>
              </p>
            </div>
            <div className="timer-container ">
              <img
                ...
                className="time-logo"
              />
              <p className="spam-paragraph">{time} sec</p>
            </div>
          </div>
        </nav>
        <div className="home-container">
          ...
          <ul className="tabs-list-container2">
            {filteredProjects.map(eachImage => (
              <Items key={eachImage.id} imageList={eachImage} />
            ))}
          </ul>
        </div>
      </>
